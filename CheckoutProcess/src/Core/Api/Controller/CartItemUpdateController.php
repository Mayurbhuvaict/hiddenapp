 ...
 */
class CartItemUpdateController extends AbstractCartItemUpdateRoute
{
    /**
     ...
     *     )
     * )
     * @Route("/store-api/checkout-process/cart/line-item", name="store-api.checkout.process.cart.update-lineitem", methods={"PATCH"})
     */
