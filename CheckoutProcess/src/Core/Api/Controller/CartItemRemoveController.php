 ...
 */
class CartItemRemoveController extends AbstractCartItemRemoveRoute
{
    /**
     ...
     *     )
     * )
     * @Route("/store-api/checkout-process/cart/line-item", name="store-api.checkout.process.cart.remove-item", methods={"DELETE"})
     */
